...
PRODUCT_BOOTANIMATION := vendor/spirit/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip
else
...
# specific init file
PRODUCT_COPY_FILES += \
    vendor/spirit/prebuilt/common/etc/init.local.rc:root/init.cm.rc
...
PRODUCT_COPY_FILES += \
    ...
    vendor/spirit/prebuilt/common/su/Superuser.apk:system/app/Superuser.apk

# SPIRIT EXTRA Files
PRODUCT_COPY_FILES += \
    vendor/spirit/prebuilt/common/app/Nova_Launcher_3.1.1beta2.apk:system/priv-app/Nova_Launcher_3.1.1beta2.apk
